...
Run:  python tests/test_craft_blind.py

No game needed: find is stubbed, so this is about what the pass does with the answers rather than
whether anything matches pixels.
