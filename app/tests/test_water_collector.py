...
Run:  python tests/test_water_collector.py --dry     read the panel, click nothing
      python tests/test_water_collector.py           run it for real
      python tests/test_water_collector.py --max 70000 --source players
