...
to end: defined in interact.craft, defaulted in craft_bot and settings, and their GUI icons on
disk. Pure data checks, no game and no tk, so this runs anywhere. Run: python tests/test_new_crafts.py
"""
import os
import sys
...
icons = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'gui', 'craft_icons')
