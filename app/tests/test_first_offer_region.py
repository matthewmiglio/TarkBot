...
Run:  python tests/test_first_offer_region.py              against the live game
      python tests/test_first_offer_region.py frame.png    against a saved full-window screenshot
...
OUT = Path(__file__).resolve().parent / 'output' / 'first_offer_region'
ZOOM = 2
