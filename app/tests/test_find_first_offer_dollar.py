...
Run:  python tests/test_find_first_offer_dollar.py              against the live game
      python tests/test_find_first_offer_dollar.py frame.png    against a saved full-window shot
...
OUT = Path(__file__).resolve().parent / 'output' / 'first_offer_dollar'
