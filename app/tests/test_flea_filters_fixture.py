...
Run:  python tests/test_flea_filters_fixture.py
      python tests/test_flea_filters_fixture.py --verbose   (name the png that matched)

No game needed. tests/fixtures/2560x1440/flea-filters-open.png is that player's screen with the
