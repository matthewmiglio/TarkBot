...
Run:  python tests/build_digit_templates.py

The fixture filename is the answer key: 43998.png segments into five glyphs left to right,
so they are a 4, a 3, a 9, a 9 and an 8. Writes them to
...
DIGITS = Path(__file__).resolve().parent.parent / 'interact' / 'reference_images' / 'price_digits'
