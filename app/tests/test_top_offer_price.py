...
Run:  python tests/test_top_offer_price.py           with a filtered flea board on screen
      python tests/test_top_offer_price.py 140000    and say what the ceiling is
...
OUT = Path(__file__).resolve().parent / 'output' / 'top_offer_price'
ZOOM = 4
