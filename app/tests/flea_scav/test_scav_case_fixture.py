...
No-game fixture test: it matches against saved 2560x1440 screenshots, no live game or window.

Run:  python tests/flea_scav/test_scav_case_fixture.py

Each fixture's own height drives find.scale(), so the reference crops are
...
FIXTURES = Path(__file__).resolve().parents[1] / 'fixtures' / '2560x1440'
