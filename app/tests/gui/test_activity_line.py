...
App layer: gui/app.py's footer activity line (App.tick painting App.activity from narrate.LAST,
trimmed by gui.app.one_line). Reads what the canvas actually drew.

Run:  python tests/gui/test_activity_line.py
