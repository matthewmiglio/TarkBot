...
App layer: gui/app.py's run-button state machine (App._set_run / App.toggle / App.stop /
App.tick over gui.app.RUN_STATES), the start -> stop -> stopping -> start cycle and the two
amber-strand traps.

Run:  python tests/gui/test_run_button.py
