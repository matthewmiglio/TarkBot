...
App layer: the end-of-run totals logging in the mode runners' start() finally block, checked on
sell_bot.FleaSeller and gym_bot.HideoutGym (their STAT_LABELS counters logged through
narrate.LAST). The GUI reads this line back off a crashed run.

Run:  python tests/gui/test_totals_line.py
