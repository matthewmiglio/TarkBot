...
App layer: gui/app.py's tab switching (App._show_tab over gui.app.TABS and DISABLED_TABS),
which must stop and join the mode being left before showing the next one.

Run:  python tests/gui/test_tab_switch.py
