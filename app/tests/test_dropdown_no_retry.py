...
No game needed, nothing is really clicked. find and pyautogui are faked, so this is only about
which branch the filter pass takes and how many times it clicks.
