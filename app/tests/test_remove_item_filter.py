...
Run:  python tests/test_remove_item_filter.py                looks only, live game
      python tests/test_remove_item_filter.py frame.png      looks only, a saved screenshot
      python tests/test_remove_item_filter.py --click        actually clears the filter
