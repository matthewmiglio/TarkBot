...
App layer under test: snipe_bot.py, the flea BUYER. The csv-backed watchlist load
(snipe_bot.targets, TARGETS_PATH) and the trader picker (trader_choices, for_trader) the GUI
builds its TRADER dropdown from. No screen reading involved.

Run:  python tests/flea_snipe/test_snipe_watchlist.py

No game needed. v1.1.0 shipped snipe_targets.csv into lib/ and then could not find it: snipe_bot is a top-level
