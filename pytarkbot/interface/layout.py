...
flea_mode_layout = [
    ...
    # stats
    [
        sg.Frame(layout=flea_mode_stats, title="Flea Mode Stats", relief=sg.RELIEF_SUNKEN, expand_x=True),
    ],
    # buttons
    [
        sg.Frame(
...
hideout_mode_layout = [
    ...
    # stats
    [
        sg.Frame(layout=hideout_mode_stats, title="Hideout Mode Stats", relief=sg.RELIEF_SUNKEN, expand_x=True),
    ],
    # buttons
    [
        sg.Frame(
...
disable_keys = user_config_keys + ["hideout_mode_start"]+ ["flea_mode_start"]
