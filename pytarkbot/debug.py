...
from pytarkbot.launcher import check_if_play_button_exists_in_launcher, wait_for_play_button_in_launcher
...
# while True:
#     print(check_if_play_button_exists_in_launcher())
    
# wait_for_play_button_in_launcher(logger)
